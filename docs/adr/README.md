...
| [002-SYNC](./002-SYNC-implement-zhr-freshness-checker-service.md) | Componente `IZhrFreshnessChecker` para verificação de dados ZHR atualizados | Proposed | 2026-07-26 |
