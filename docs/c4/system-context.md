...
Enterprise_Boundary(marinha, "Marinha") {
    ...
    System(pessoas_integracao, "PIIP", "Centraliza, normaliza e disponibiliza dados das pessoas")
...
Rel(pessoas_integracao, sigdn_rh, "Obtém dados das pessoas (consulta/extração)")
@enduml
```
