...
public class ZhrWsGenericClientTest()
{
    ...
    public async Task ShouldOrchestrateSoapCallCorrectly_WhenValidRequestIsMade()
    {
        ...
        var result = await uut.CallAsync(
            DelegatedFunc,
            (response) => response.ZhrWsAptidaoResponse.Output,
            pessoaSyncRefs,
        ...
        // Assert
        result.Should().BeSameAs(expectedResponse.ZhrWsAptidaoResponse.Output);
    ...
    public async Task ShouldOrchestrateSoapCallCorrectly_WhenNoRefsAreProvided()
    {
        ...
        var selectOutputFuncMock = new Mock<Func<ZhrWsAptidaoResponse1, ZhrSAptidaoOutput[]>>();

        // Act
        var result = await uut.CallAsync(
            soapOperationMock.Object,
            selectOutputFuncMock.Object,
            pessoaSyncRefs,
            ct: TestContext.Current.CancellationToken
        );
        ...
        selectOutputFuncMock.Verify(op => op(It.IsAny<ZhrWsAptidaoResponse1>()), Times.Never);
    }
