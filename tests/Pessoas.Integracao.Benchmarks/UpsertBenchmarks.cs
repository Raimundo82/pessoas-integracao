...
public class UpsertBenchmarks
{
    ...
    private PessoaRepository _repo = null!;
    ...
    [Benchmark]
    public Task UpsertAllAsync() => _repo.UpsertAllAsync(_pessoas, _ct);

    [Benchmark]
    public Task ReplaceAllAsync() => _repo.ReplaceAllAsync(_pessoas, _ct);
