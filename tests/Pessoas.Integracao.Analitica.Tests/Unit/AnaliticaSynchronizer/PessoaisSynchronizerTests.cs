...
public sealed class PessoaisSynchronizerTests
{
    ...
    [Fact]
    public async Task ShouldSyncPessoais_WhenDataIsProvided()
    {
        // Arrange
        string ni = "1", externalId = "3000";
        var timestamp = new DateTimeOffset(new DateTime(2025, 1, 1));
        var item = new ZhrSPessoais { Ni = ni };
        var outputs = new List<IZhrOutput>
        {
            ZhrOutputTestData
            .OutputWith(
        ...
        var transformed = new List<ZhrWsPersonalDataPessoai>
        {
    ...
    public async Task ShouldSyncAllTransformedItems_WhenMultipleOutputsAreProvided()
    {
        ...
        var output1 = ZhrOutputTestData.OutputWith(
            ...
            updateAt: timestamp,
            pessoais: [new ZhrSPessoais { Ni = ni1, Apelido = "Toni" }]
        );
        ...
        var output2 = ZhrOutputTestData.OutputWith(
            ...
            updateAt: timestamp,
            pessoais: [new ZhrSPessoais { Ni = ni1, Apelido = "Bujo" }]
        );

        var outputs = new List<IZhrOutput> { output1, output2 };
        var transformed = new List<ZhrWsPersonalDataPessoai>
        {
            new(){ Ni = ni1, Apelido = "Toni", Numsap = externalId1, UpdatedAt = timestamp },
            new(){ Ni = ni1, Apelido = "Bujo", Numsap = externalId2, UpdatedAt = timestamp }
        };
    ...
    public async Task ShouldPropagateCancellationToken_WhenSyncingData()
    {
        ...
        var outputs = new List<IZhrOutput> { ZhrOutputTestData.OutputWith(pessoais: [new ZhrSPessoais { Ni = "1" }]) };
        var transformed = new List<ZhrWsPersonalDataPessoai> { new() { Ni = "1" } };
    ...
    private PessoaisSynchronizer CreateSut() => new(_transformer.Object, _repository.Object);
