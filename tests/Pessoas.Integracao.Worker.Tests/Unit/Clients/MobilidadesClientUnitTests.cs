    ...
    public async Task ShouldPropagateCancellationToken_WhenExecutingGetMobilidadesAsync()
    {
        ...
        _soapChannel
            ...
            .Returns(async () =>
            {
                ...
                return new ZhrWsMobilidadesResponse1
                {
                    ZhrWsMobilidadesResponse = new ZhrWsMobilidadesResponse { Output = [] }
                };
            });
        _soapChannelProvider.Setup(f => f.CreateChannel()).Returns(_soapChannel.Object);
        ...
        // Assert
        await Assert.ThrowsAsync<OperationCanceledException>(() => getMobilidadesTask);
    }
