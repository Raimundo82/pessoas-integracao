...
namespace Pessoas.Integracao.Worker.Infrastructure.Sigdn.Rh.Soap.Clients.PersonalData;
...
public class PersonalDataClient(
    ...
    ) : SoapBaseClient<zhr_wsChannel>(soapChannelProvider), IPersonalDataClient
{
